...
class RecipesViewModel @ViewModelInject constructor(
    ...
    fun saveMealAndDietType(
        ...
        mealTypeId: Int,
        dietType:String,
        dietTypeId:Int) = viewModelScope.launch(Dispatchers.IO){
    ...
    fun saveBackOnline(backOnline: Boolean)=
     ...
     fun applyQueries():HashMap<String, String>{
        val queries: HashMap<String, String> = HashMap()
         ...
         //default values of mealType and dietType will be changed with the values that came from the flow
    ...
    //applying queries to search in Spoonacular Api DB
    ...
    fun showNetworkStatus(){
        //in case of loosing Internet connection display Toast and persist backOnline value to true
        if(!networkStatus){
            Toast.makeText(getApplication(), "No Internet Connection.", Toast.LENGTH_SHORT).show()
            saveBackOnline(true)
            //in case having Internet connection back display Toast and persist backOnline value to false
